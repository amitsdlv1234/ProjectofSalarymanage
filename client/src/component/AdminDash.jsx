...
const AdminDash = () => {
  ...
  return (
    ...
    <Cardtab>
    <Box onClick={()=>navigate(`/AllMemberComponent/admin/${year}/${month}`)}>
      <Typography variant='h4'margin={'auto'}>All Data</Typography>
    </Box>
    ...
    <Cardtab>
    <Box onClick={()=>navigate(`/getDirector/admin/${year}/${month}`)}>
      <Typography variant='h4'margin={'auto'}>Pay to Director</Typography>
    </Box>
    <Box onClick={()=>navigate(`/DA_PersentData`)}>
      <Typography variant='h4'margin={'auto'}>Change DA_Percent</Typography>
    </Box>
    </Cardtab>
    </>
  )
